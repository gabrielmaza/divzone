      ...
      {!isAboveMediumScreens && isOpen && (
        ...
        >
          ...
          >
            ...
            {/* <MyLink selectedPage={selectedPage} setSelectedPage={setSelectedPage} page="Services" /> */}
            <MyLink selectedPage={selectedPage} setSelectedPage={setSelectedPage} page="Contact Us" />
            <a href="https://divzone-react-theme-docs.vercel.app/docs/intro" target="_blank" className="text-white transition duration-500 hover:text-gray-600 cursor-pointer">Docs</a>
            <hr />
            <div className="flex flex-col gap-8">
              <a href="https://divzone-react-theme-docs.vercel.app/docs/intro" title="Sign in MyLink" className={`transition duration-500 hover:text-gray-600`}>Docs</a>
              <a href="https://github.com/gabrielmaza/divzone-react-theme" className="rounded-md bg-transparent border-solid border border-white px-6 py-2 cursor-pointer transition duration-500 hover:bg-gray-800 text-center">
