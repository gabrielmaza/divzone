...
export default function Main({ setSelectedPage }: Props) {
  return (
    <section
      id="home"
      className="gap-16 bg-gray-900 pb-10 pt-[90px] md:h-full md:pb-0"
    >
        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            <div className="relative">
              <Image
                className="absolute w-full scale-150 top-[-6rem] left-[-6rem] z-[-1] opacity-50"
                src={backgroundSparkles}
                alt={"background sparkles img"}
              />
              <div className="text-center flex flex-col justify-center items-center">
                <span className="font-extrabold text-3xl sm:text-6xl sm:leading-[4rem] text-center">
